...
measure "SBCL compiled native function" sbcl --noinform --non-interactive --load "$root/benchmarks/fib.lisp" --eval '(fib 34)'
...
measure "SBCL compiled native function" sbcl --noinform --non-interactive --load "$root/benchmarks/parallel-sum.lisp" --eval '(benchmark-result)'
...
measure "SBCL compiled native function" sbcl --noinform --non-interactive --load "$root/benchmarks/mandelbrot.lisp" --eval '(benchmark-result)'
